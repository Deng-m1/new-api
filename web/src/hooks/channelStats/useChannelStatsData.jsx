...
export const useChannelStatsData = () => {
  ...
  const loadPerformanceData = useCallback(async () => {
    ...
    try {
      ...
      const url = isAdminUser
        ? `/api/channel/stats/performance?start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}${channelIdsParam}`
        : `/api/channel/stats/self?type=performance&start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}`;
  ...
  }, [getTimestampRange, selectedChannelIds, isAdminUser, t]);
  ...
  const loadUsageData = useCallback(async () => {
    ...
    try {
      ...
      const url = isAdminUser
        ? `/api/channel/stats/usage?start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}&time_granularity=${timeGranularity}${channelIdsParam}`
        : `/api/channel/stats/self?type=usage&start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}&time_granularity=${timeGranularity}`;
  ...
  }, [getTimestampRange, selectedChannelIds, timeGranularity, isAdminUser, t]);
  ...
  const loadHealthData = useCallback(async () => {
    ...
    try {
      ...
      const url = isAdminUser
        ? `/api/channel/stats/health?start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}${channelIdsParam}`
        : `/api/channel/stats/self?type=health&start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}`;
  ...
  const loadRealtimeData = useCallback(async () => {
    try {
      ...
      const url = isAdminUser
        ? `/api/channel/stats/realtime${channelIdsParam}`
        : `/api/channel/stats/self?type=realtime`;
  ...
  }, [selectedChannelIds, isAdminUser]);
  ...
  const loadErrorData = useCallback(async () => {
    ...
    try {
      ...
      const url = isAdminUser
        ? `/api/channel/stats/errors?start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}&time_granularity=${timeGranularity}${channelIdsParam}`
        : `/api/channel/stats/self?type=errors&start_timestamp=${startTimestamp}&end_timestamp=${endTimestamp}&time_granularity=${timeGranularity}`;
